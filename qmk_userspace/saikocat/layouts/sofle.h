...
#define __LLY__ADJUST \
    ...
    _______, KC_EQL,  KC_4,    KC_5,    KC_6,    KC_PPLS,                      DF(_COLEMAK_DH), KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______, \
    _______, KC_P0,   KC_1,    KC_2,    KC_3,    KC_PSLS, XXXXXXX,    XXXXXXX, DF(_RAISE),      KC_F1,   KC_F2,   KC_F3,   KC_F12,  KC_LGUI, \
                  _______, _______,  KC_PDOT,    _______, _______,    _______, _______, _______, _______, _______
