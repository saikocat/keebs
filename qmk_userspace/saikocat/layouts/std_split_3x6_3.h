...
#define __LLY_S3X6H3__QWERTY \
    ...
    KC_LSFT, _________________QWERTY_L3_________________,        _________________QWERTY_R3_________________, MO(_ADJUST), \
...
#define __LLY_S3X6H3__COLEMAK_DH \
    ...
    KC_LSFT, ______________COLEMAK_MOD_DH_L3____________,        ______________COLEMAK_MOD_DH_R3____________, MO(_ADJUST), \
             _____________BOTTOM_HOMEROW_L______________,        _____________BOTTOM_HOMEROW_R______________
...
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |  *   |  7   |  8   |  9   |  -   |                | DF(0)| DF(1)| DF(3)| DF(6)| PSCR |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |  =   |  4   |  5   |  6   |  +   |                | LEFT | DOWN |  UP  | RIGHT| SHFT |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |  0   |  1   |  2   |  3   |  /   |                | HOME | PGDN | PGUP | END  | INS  |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------'
 *                             |  .   |      |      |  |      |      |      |
 *                             `--------------------'  `--------------------'
 */
 ...
 * |      |      |      | C(F) |      |      |                |      |  F7  |  F8  |  F9  |  F10 |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |  SFT | LGUI | ALT  | CTRL | CAPS |                |      |  F4  |  F5  |  F6  |  F11 |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
...
#define __LLY_S3X6H3__GAME_NUM \
    KC_ESC,    C(KC_1), C(KC_2), C(KC_3), C(KC_4), C(KC_5),        DF(_QWERTY), DF(_COLEMAK_DH), DF(_RAISE), DF(_GAME),  KC_PSCR, _______, \
...
#define __LLY_S3X6H3__NUM_TRADITIONAL \
    ...
    _______, C(KC_1), C(KC_2), C(KC_3), C(KC_4), C(KC_5),        KC_EQL,  KC_4,   KC_5,    KC_6,    KC_PPLS,   KC_PDOT, \
    _______, ________________NUMBER_RIGHT_______________,        KC_P0,   KC_1,   KC_2,    KC_3,    KC_PMNS,   KC_PAST, \
                               _______, _______, _______,        _______, _______, _______
