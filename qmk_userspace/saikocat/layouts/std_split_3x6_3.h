...
#define __LLY_S3X6H3__GAME_NUM \
    KC_ESC,    ________________NUMBER_LEFT_BEAKL__________,        DF(_QWERTY), DF(_COLEMAK_DH), DF(_RAISE), DF(_GAME),  KC_PSCR, _______, \
    KC_LCTL,   C(KC_3), C(KC_2), C(KC_1), C(KC_0), C(KC_4),        ___________________BLANK___________________, _______, \
...
#define __LLY_S3X6H3__NUM \
    _______, ________________NUMBER_LEFT_BEAKL__________,      KC_EQL,   KC_7,  KC_8,  KC_9,  KC_0,     KC_BSPC, \
    _______, C(KC_3), C(KC_2), C(KC_1), C(KC_5), C(KC_4),      KC_PAST,  KC_4,  KC_5,  KC_6,  KC_PSLS,  _______, \
    _______, ________________NUMBER_RIGHT_BEAKL_________,      KC_PMNS,  KC_1,  KC_2,  KC_3,  KC_PPLS,  _______, \
                               _______, _______, _______,      KC_ENT,  KC_P0, _______
