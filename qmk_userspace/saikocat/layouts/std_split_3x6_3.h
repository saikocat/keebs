...
#define __LLY_S3X6H3__QWERTY \
    ...
    KC_LSFT, _________________QWERTY_L3_________________,        _________________QWERTY_R3_________________, KC_DEL,  \
             _______________3x3_HOMEROW_L_______________,        _______________3x3_HOMEROW_R_______________


#define __LLY_S3X6H3__HOMEROW_QWERTY \
    KC_TAB,  _________________QWERTY_L1_________________,        _________________QWERTY_R1_________________, KC_BSPC, \
    KC_LCTL, KC_A,  ALT_S, SFT_D, CTL_F, KC_G,                   KC_H, CTL_J, SFT_K,   ALT_L,  KC_SCLN,       KC_QUOT, \
...
#define __LLY_S3X6H3__HOMEROW_COLEMAK_DH \
    KC_TAB,  ______________COLEMAK_MOD_DH_L1____________,        ______________COLEMAK_MOD_DH_R1____________, KC_BSPC, \
    KC_LCTL, KC_A,  ALT_R, SFT_S, CTL_T, KC_G,                   KC_M, CTL_N, SFT_E,   ALT_I,   KC_O,         KC_QUOT, \
...
#define __LLY_S3X6H3__GAME \
    ...
    KC_LSFT, _________________QWERTY_L3_________________,        ___________________BLANK___________________, A(KC_TAB), \
                           SH_MON, KC_SPC, MO(_GAME_NUM),        _______________3x3_HOMEROW_R_______________
...
#define __LLY_S3X6H3__GAME_NUM \
    ...
    KC_SFTENT, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,          ___________________BLANK___________________, _______, \
                                _______, _______, _______,         _______________3x3_HOMEROW_R_______________
