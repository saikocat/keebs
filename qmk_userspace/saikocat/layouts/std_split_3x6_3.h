...
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |      |      | CTRL |G(SPC)|      |                | DF(0)| DF(1)| DF(3)| DF(6)| PSCR |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |PRVWRD|NXTWRD| CTAB | PTAB | ATAB |                | LEFT | DOWN |  UP  | RIGHT| INS  |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |  GUI |  ALT |  SFT | ATAB |      |                | HOME | PGDN | PGUP | END  |      |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------'
 *                             |      |      |      |  |  SFT |      |      |
 *                             `--------------------'  `--------------------'
 */
...
#define __LLY_S3X6H3__NUM_TRADITIONAL \
    ...
    _______, C(KC_1), C(KC_2), C(KC_3), C(KC_4), C(KC_5),        KC_PPLS,  KC_4,   KC_5,  KC_6,  KC_P0,        _______, \
    _______, ________________NUMBER_RIGHT_______________,        KC_EQL,   KC_1,   KC_2,  KC_3,  KC_PMNS,      _______, \
