...
#define __LLY_S3X6H3__NUM \
    _______, C(KC_3), C(KC_2), C(KC_1), C(KC_5), C(KC_4),      KC_EQL,   KC_7,  KC_8,  KC_9,  KC_0,     KC_BSPC, \
    _______, ________________NUMBER_LEFT_BEAKL__________,      KC_PAST,  KC_4,  KC_5,  KC_6,  KC_PSLS,  _______, \
