...
#define ____________THUMBCLUSTER_KYRIA_L___________    _______,  ESC_ALT,  DEL_LWR,    BSPC_NUM, SPC_SFT
#define ____________THUMBCLUSTER_KYRIA_R___________    ENT_SFT,  KC_SPC,   MO(_RAISE), COLN_ADJ, _______
 ...
 *                        `----------------------------------'  `----------------------------------'
 */
#define __LAYOUT_KYRIA__LOWER_BAK \
    ...
    KC_SFTENT, _________________SYMBOL_L3_________________, _______, _______,    _______, _______, _________________SYMBOL_R3_________________, _______, \
                                 _______, SH_MON,  _______, _______, _______,    _______, _______, MO(_SYMNUM), MO(_SPECIAL), _______
...
#define __LAYOUT_KYRIA__LOWER \
    ...
    _______, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  KC_BSLS,                                        ________________HOME_ROW_OSM_R_____________, _______, \
    ENT_SFT, ________________NUMBER_RIGHT_______________, _______, _______,    _______, _______, ___________________BLANK___________________, _______, \
                                _______, SH_MON, _______, _______, _______,    _______, _______, MO(_ADJUST), MO(_SPECIAL), _______
...
#define __LAYOUT_KYRIA__NUM \
    ...
    _______, ________________HOME_ROW_OSM_L_____________,                                        ________________NUMPAD_MID_________________,  _______, \
    _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, ________________NUMPAD_BOT_________________,  _______, \
